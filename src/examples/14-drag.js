...
ball.position.set(0, 20, -50); // Set the position of the sphere
ball.rigidBody.velocity.set(0, 0, 30); // Set the velocity of the sphere
...
ubik.update = (dt) => {
    if (ball.position.y <= 4) {
        const dragForce = ubik.forces.generateDragForce(0.05, ball.rigidBody.velocity);
